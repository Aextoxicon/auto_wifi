...
curl --http1.1 -X POST -H "Authorization: Bearer $API_TOKEN" -F "file=@eureka_mac.zip" http://update.aextoxicon.site/upload
curl --http1.1 -X POST -H "Authorization: Bearer $API_TOKEN" -F "file=@eureka_android.apk" http://update.aextoxicon.site/upload